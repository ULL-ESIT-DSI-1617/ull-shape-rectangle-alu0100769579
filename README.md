[![Build Status](https://travis-ci.org/ULL-ESIT-DSI-1617/ull-shape-rectangle-alu0100769579.svg?branch=master)](https://travis-ci.org/ULL-ESIT-DSI-1617/ull-shape-rectangle-alu0100769579)

## Práctica: Evaluar Módulos

### ull-shape-rectangle-alu0100769579

#### Install

    ```js
    npm install @alu0100769579/ull-shape-rectangle-alu0100769579
    ```

#### Use

    ```js
    require('@alu0100769579/ull-shape-rectangle-alu0100769579');
    ```
